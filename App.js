...
const SchoolCodeInputScreen = ({ navigation }) => {
  ...
  //add an else if that checks for portlandschools app, which still needs to be created
  ...
  return (
    ...
    <View style={styles.horizontalLine3} />
      ...
      <Button title=" + Add my school" onPress= {() => navigation.navigate('newSchoolFormScreen')} />
     </View>
...
const TipsScreen = ({ navigation }) => {
  ...
  const ListFooter = () => (
      ...
      <Text style= {[styles.descriptionText1, {paddingTop: 20, paddingBottom: 8}]}>
        {'Would you like to suggest something? \n'}
        </Text>

        <TouchableOpacity style={styles.footerContainerButton} onPress={handlePress}>
...
//add a new screen syntax
const newSchoolFormScreen = ({navigation}) => {
  return(
<View style= {styles.headingNSform}>
